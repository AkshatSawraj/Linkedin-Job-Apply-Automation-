...
class EasyApplyLinkedin:
    ...
    def login_linkedin(self):
        ...
        try:
            self.driver.find_element_by_xpath("//form[@id='remember-me-prompt__form-primary']").submit()
    ...
    def filter(self):
        ...
        """
        <button aria-checked="false" role="radio" aria-label="Easily Apply filter." id="ember1393" class="artdeco-pill artdeco-pill--slate artdeco-pill--2 artdeco-pill--choice ember-view search-reusables__filter-pill-button" type="button">  
    Easily Apply
  
</button>
        """
        #all_filters_button = self.driver.find_element_by_class_name("artdeco-pill.artdeco-pill--slate.artdeco-pill--2.artdeco-pill--choice.ember-view.search-reusables__filter-pill-button")
        
        #all_filters_button = self.driver.find_element_by_xpath("//button[@aria-label='Easy Apply filter.' and @class='artdeco-pill.artdeco-pill--slate.artdeco-pill--2.artdeco-pill--choice.ember-view.search-reusables__filter-pill-button']")
    ...
    def find_offers(self):
        ...
        results = self.driver.find_elements_by_class_name("disabled.ember-view.job-card-container__link.job-card-list__title")
    ...
    def submit_apply(self):
        ...
        print('You are applying to the position  ')
        ...
        # ... if not available, discard application and go to next
            ...
            try:
                time.sleep(2)
                next=self.driver.find_element_by_xpath("//button[@data-control-name='continue_unify']")
                next.click()
                time.sleep(2)
                next2=self.driver.find_element_by_xpath("//button[@data-control-name='continue_unify']")
                next2.click()
